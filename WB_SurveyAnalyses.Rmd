...
mosaicplot(depth.quad, main = "Field Qual vs depth", xlab= "Depth", ylab= "Quad percent cover", col=T) 

  #use table stuff starting line 500 to make mosaicplot. same principle as this code to do by quadrat by season
...
mosaicplot(season.quad, main = "Month Collected vs Quad Percent Cover", xlab = "Quad Percent Cover", ylab = "Month Collected", col=T)
