...
wb.nmds$WD.field.est.trace.p <- wb.nmds$WD.field.est.trace / (wb.nmds$WD.field.est.absent + wb.nmds$WD.field.est.trace + wb.nmds$WD.field.est.low + wb.nmds$WD.field.est.mid + wb.nmds$WD.field.est.high)

wb.nmds$WD.field.est.low.p <- wb.nmds$WD.field.est.low / (wb.nmds$WD.field.est.absent + wb.nmds$WD.field.est.trace + wb.nmds$WD.field.est.low + wb.nmds$WD.field.est.mid + wb.nmds$WD.field.est.high)

wb.nmds$WD.field.est.mid.p <- wb.nmds$WD.field.est.mid / (wb.nmds$WD.field.est.absent + wb.nmds$WD.field.est.trace + wb.nmds$WD.field.est.low + wb.nmds$WD.field.est.mid + wb.nmds$WD.field.est.high)
...
```{r}
plot(wd.prevalence ~ canopy.height.cm, data = filter(wb.depth, wd.prevalence != "NA"), ylim = c(0,1.1))

plot(wd.prevalence ~ zm.veg.density0.0625m2, data = filter(wb.depth, wd.prevalence != "NA"), ylim = c(0,1.1))
